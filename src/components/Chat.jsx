...
const Chat = () => {
  ...
  return (
    <div className="nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96 border-1 border-color dark:border-white">
      <div className="flex justify-between items-center">
        <div className="flex gap-3">
          <p className="font-semibold text-lg dark:text-gray-200">Messages</p>
          <button type="button" className="text-gray-400 dark:text-white text-xs rounded p-1 px-2 bg-orange">
            5 New
          </button>
        </div>
        <button type='button' onClick={() => handleUnclick('chat')} style={{color: 'rgb(153,171,180)',borderRadius:'50%'}} className='text-2xl p-3 hover:drop-shadow-xl hover:bg-light-gray'>
            <MdOutlineCancel />
        </button>
      </div>
      <div className="mt-5 ">
