    ...
    <div className='mt-12'>
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          ...
          <div className='mt-6'>
            <Button color='white' bgColor='red' text='Download' borderRadius='10px' size='md' />
          </div>
        </div>
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        <div className='bg-white dar:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex flex-wrap justify-center gap-10'>
            <div className='border-r-1 border-color m-4 pr-10'>
              ...
              <div className='mt-10'>
                <Button color='white' bgColor='red' text='Download Report' borderRadius='10px' />
              </div>
            </div>
            <div>
